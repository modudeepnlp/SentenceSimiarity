...
def train_model(cuda, vocab_file, data_json, save_pretrain_file):
    ...
    train_loader = data.build_pretrain_loader(data_json, vocab, config.n_batch)
...
if __name__ == '__main__':
    ...
    data_json = f"../data/pretrain_bert_{args.vocab}_0"
    save_pretrain_file = f"save_pretrain_{args.vocab}.pth"

    train_model(args.cuda, vocab_file, data_json, save_pretrain_file)
